...
<head>
  ...
  <!-- Favicons -->
  <link href="../dist/img/LogoInicio.png" rel="icon">
  ...
  <link href="../dist/css/inicio/style.css" rel="stylesheet">
...
<!--CSS Modal-->
  ...
  <link rel="stylesheet" href="../dist/css/inicio/styless.css">
...
<!--Modal-->
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 order-1 order-lg-2 hero-img">
          <img src="../dist/img/Log.png" class="img-fluid animated" alt="">
        </div>
      </div>
    </div>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch">
            <form action="dist/forms/contact.php" method="post" role="form" class="php-email-form">
              <div class="row">
  ...
  <!-- Vendor JS Files -->
  <script src="../public/dist/vendor/purecounter/purecounter_vanilla.js"></script>
  <script src="../public/dist/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
  <script src="../public/dist/vendor/glightbox/js/glightbox.min.js"></script>
  <script src="../public/dist/vendor/isotope-layout/isotope.pkgd.min.js"></script>
  <script src="../public/dist/vendor/swiper/swiper-bundle.min.js"></script>
  <script src="../public/dist/vendor/php-email-form/validate.js"></script>

  <!-- Template Main JS File -->
  <script src="../public/dist/js/inicio/main.js"></script>



  <script src="../public/dist/js/inicio/jquery.min.js"></script>
